...
public class SegregationModelTest extends DukeApplicationTest {
  ...
  public void testConstructorSegregation() {
    Model testModel = new Model("SegregationExample.csv", "Segregation");
  ...
  public void testStepSegregation10Example2() {
    Model testModel = new Model("Segregation10Example2.csv", "Segregation");
  ...
  public void testStepSegregation20Example2() {
    Model testModel = new Model("Segregation20Example2.csv", "Segregation");
